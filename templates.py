...
class UI:
    ...
    def _listar_contas(self, filter=lambda x:True):
        contas = listar_contas()
        for conta in contas:
            if filter(conta):
                print(f'{conta.id} = {conta.banco.value}')
    ...
    def _desativar_conta(self):
        ...
        self._listar_contas(lambda conta: conta.status == Status.ATIVO)
    ...
    def _ativar_conta(self):
        ...
        self._listar_contas(lambda conta: conta.status == Status.INATIVO)
